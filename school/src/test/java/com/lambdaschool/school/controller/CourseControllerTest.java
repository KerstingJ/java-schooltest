...
public class CourseControllerTest
{
    ...
    public void listAllCourses() throws Exception
    {
        ...
        // when this method gets called return this thing
        Mockito.when(courseService.findAll()).thenReturn(new ArrayList<>(courseList));

        // lets build a httprequest to send to our mock mvc
        RequestBuilder rb = MockMvcRequestBuilders.get(apiUrl).accept(MediaType.APPLICATION_JSON);
        // lets make our mock request and get the result
        MvcResult r = mockMvc.perform(rb).andReturn();
        // get response data as a string
        String tr = r.getResponse().getContentAsString();

        // create an object to map over out list and turn it into a json string
